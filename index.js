...
const PORT = process.env.SERVER_PORT || process.env.PORT || 5678;        // http服务订阅端口
const UUID = process.env.UUID || '77b9cf98-4d0d-4bfb-8896-7bc166f38aa0'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'testaa.868306.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjU1MDM5ZmZjOGI3ZjM0NzZjZWE5OTQxOTQwZWQ5OGQiLCJ0IjoiNmY0MDFlNmItZjJhNC00YzBlLWFmZGEtOTJhYzg1N2U5MzQxIiwicyI6Ik16ZGtNbU0xTURBdFpEZzNNQzAwTTJObUxUaGlaVFF0T1dabE1UQm1aRE5sTWpCaCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
